                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter project title" value={{$task->title}}>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="form-control" id="status" name="status" >
                                    <option @if($task->status == 'Inprogress') selected @endif value="Inprogress">Inprogress</option>
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <input type="text" class="form-control"  id="deadline" name="deadline" 
                                        placeholder="Enter due date" data-provider="flatpickr" value={{$task->deadline}}>
                                </div>
                            </div>
                        </div>
                    </div>
