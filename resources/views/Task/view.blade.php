                    ...
                    <div class="card-body">
                        <div class="p-3 mt-n3 mx-n3 bg-soft-secondary rounded-top">
                            <div class="d-flex gap-1 align-items-center justify-content-end my-n2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="/update/{{$userTask->id}}"><i
                            ...
                            <div class="text-center pb-3">
                                <img src="{{ URL::asset('images/tasksimages/' . $userTask->image) }}" alt="" height="52">
                            </div>
                        </div>

                        <div class="py-3">
                            <h5 class="fs-14 mb-3"><a href="apps-projects-overview" class="text-dark">{{$userTask->title}}</a></h5>
                            <div class="row gy-3">
                                <div class="col-6">
                                    <div>
                                        <p class="text-muted mb-1">Status</p>
                                        <div class="badge badge-soft-warning fs-12">{{$userTask->status}}</div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div>
                                        <p class="text-muted mb-1">Deadline</p>
                                        <h5 class="fs-14">{{$userTask->deadline}}</h5>
                                    </div>
                                </div>
                            </div>
...
<!-- Pagination Starts from Here.... -->
    ...
    <!-- removeProjectModal -->
    @foreach ($userTasks as $userTask)
        <form action="/delete/{{$userTask->id}}" method="POST">
            @csrf
            @method('DELETE')
